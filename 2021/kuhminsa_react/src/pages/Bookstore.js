    ...
    <main className="sub bookstore wrapper">
      ...
      <div className="content">
        ...
        <section>
          <h3>온라인 서점</h3>
          <div className="links">
            <Link to="http://www.kyobobook.co.kr" target="_blank">
              <div className="image">
                <img src={require("../assets/images/logo/bookstore/kyobo.jpg")} alt="교보문고 사이트 바로가기" />
              </div>
              <span>교보문고</span>
            </Link>
            <Link to="http://www.ypbooks.co.kr" target="_blank">
              <div className="image">
                <img src={require("../assets/images/logo/bookstore/ypbooks.jpg")} alt="영풍문고 사이트 바로가기" />
              </div>
              <span>영풍문고</span>
            </Link>
            <Link to="http://book.interpark.com" target="_blank">
              <div className="image">
                <img src={require("../assets/images/logo/bookstore/interpark.jpg")} alt="인터파크 도서 사이트 바로가기" />
              </div>
              <span>인터파크도서</span>
            </Link>
            <Link to="http://www.yes24.com" target="_blank">
              <div className="image">
                <img src={require("../assets/images/logo/bookstore/yes24.jpg")} alt="예스24 사이트 바로가기" />
              </div>
              <span>예스24</span>
            </Link>
            <Link to="http://www.bandinlunis.com" target="_blank">
              <div className="image">
                <img src={require("../assets/images/logo/bookstore/bandinlunis.jpg")} alt="반디앤루니스 사이트 바로가기" />
              </div>
              <span>반디앤루니스</span>
            </Link>
            <Link to="https://books.11st.co.kr" target="_blank">
              <div className="image">
                <img src={require("../assets/images/logo/bookstore/11st.jpg")} alt="도서11번가 사이트 바로가기" />
              </div>
              <span>도서11번가</span>
            </Link>
            <Link to="#" target="_blank">
              <div className="image">
                <img src={require("../assets/images/logo/bookstore/kjbooks.jpg")} alt="검정서적 사이트 바로가기" />
              </div>
              <span>검정서적</span>
            </Link>
            <Link to="http://www.techbible.co.kr" target="_blank">
              <div className="image">
                <img src={require("../assets/images/logo/bookstore/techbible.jpg")} alt="Tech Bible 사이트 바로가기" />
              </div>
              <span>Tech Bible</span>
            </Link>
            <Link to="https://www.ykbook.com" target="_blank">
              <div className="image">
                <img src={require("../assets/images/logo/bookstore/ykbooks.jpg")} alt="영광도서 사이트 바로가기" />
              </div>
              <span>영광도서</span>
            </Link>
            <Link to="https://www.libro.co.kr" target="_blank">
              <div className="image">
                <img src={require("../assets/images/logo/bookstore/libro.jpg")} alt="대교 Libro 사이트 바로가기" />
              </div>
              <span>대교 Libro</span>
            </Link>
            <Link to="https://www.aladin.co.kr" target="_blank">
              <div className="image">
                <img src={require("../assets/images/logo/bookstore/aladin.jpg")} alt="알라딘 사이트 바로가기" />
              </div>
              <span>알라딘</span>
            </Link>
          </div>
